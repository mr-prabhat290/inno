...
BOT_USERNAME = getenv("BOT_USERNAME", "@Music_jullet_bot")
BOT_NAME = getenv("BOT_NAME", "None")
ASSUSERNAME = getenv("ASSUSERNAME", "None")
EVALOP = list(map(int, getenv("EVALOP", "7466643799").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://t.me/Romentic_lover")
